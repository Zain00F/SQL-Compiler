// Generated from c:/Users/zaina/Desktop/sqlTemp/sql compiler/grammar/SQL.g4 by ANTLR 4.13.1
...
public class SQL extends Lexer {
	...
	public static final int
		...
		FOR=67, FOREIGN=68, FREETEXT=69, FREETEXTTABLE=70, FROM=71, FALSE=72, 
		FULL=73, FUNCTION=74, GOTO=75, GO=76, GRANT=77, GROUP=78, HAVING=79, HOLDLOCK=80, 
		...
		TRANSACTION=166, TRUE=167, TRIGGER=168, TRUNCATE=169, TRY_CONVERT=170, 
		TSEQUAL=171, UNION=172, UNIQUE=173, UNPIVOT=174, UPDATE=175, UPDATETEXT=176, 
		USE=177, USER=178, VALUES=179, VARYING=180, VIEW=181, WAITFOR=182, WHEN=183, 
		WHERE=184, WHILE=185, WITH=186, WITHIN=187, WRITETEXT=188, ASSIGN_ADD=189, 
		ASSIGN_MIN=190, PLUS=191, MINUS=192, MULTIPLY=193, DIVIDE=194, COMMA=195, 
		SEMICOLON=196, EQUALS=197, GREATER_THAN=198, LESS_THAN=199, GREATER_EQUAL=200, 
		LESS_EQUAL=201, NOT_EQUAL=202, LEFT_PAREN=203, RIGHT_PAREN=204, LEFT_BRACKET=205, 
		RIGHT_BRACKET=206, IDENTIFIER=207, USER_VARIABLE=208, SYSTEM_VARIABLE=209, 
		INTEGER=210, FLOAT=211, SINGLE_QUOTE_STRING=212, DOUBLE_QUOTE_STRING=213, 
		HEX_STRING=214, BIT_STRING=215, SINGLE_LINE_COMMENT=216, NESTED_BLOCK_COMMENT=217, 
		WS=218;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FOR", "FOREIGN", "FREETEXT", "FREETEXTTABLE", "FROM", "FALSE", "FULL", 
			"FUNCTION", "GOTO", "GO", "GRANT", "GROUP", "HAVING", "HOLDLOCK", "IDENTITY", 
			...
			"THEN", "TO", "TOP", "TRAN", "TRANSACTION", "TRUE", "TRIGGER", "TRUNCATE", 
			"TRY_CONVERT", "TSEQUAL", "UNION", "UNIQUE", "UNPIVOT", "UPDATE", "UPDATETEXT", 
			"USE", "USER", "VALUES", "VARYING", "VIEW", "WAITFOR", "WHEN", "WHERE", 
			"WHILE", "WITH", "WITHIN", "WRITETEXT", "ASSIGN_ADD", "ASSIGN_MIN", "PLUS", 
			"MINUS", "MULTIPLY", "DIVIDE", "COMMA", "SEMICOLON", "EQUALS", "GREATER_THAN", 
			"LESS_THAN", "GREATER_EQUAL", "LESS_EQUAL", "NOT_EQUAL", "LEFT_PAREN", 
			"RIGHT_PAREN", "LEFT_BRACKET", "RIGHT_BRACKET", "IDENTIFIER", "USER_VARIABLE", 
			"SYSTEM_VARIABLE", "INTEGER", "FLOAT", "SINGLE_QUOTE_STRING", "DOUBLE_QUOTE_STRING", 
			"HEX_STRING", "BIT_STRING", "SINGLE_LINE_COMMENT", "NESTED_BLOCK_COMMENT", 
			"WS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'FOR'", "'FOREIGN'", "'FREETEXT'", "'FREETEXTTABLE'", "'FROM'", "'FALSE'", 
			"'FULL'", "'FUNCTION'", "'GOTO'", "'GO'", "'GRANT'", "'GROUP'", "'HAVING'", 
			"'HOLDLOCK'", "'IDENTITY'", "'IDENTITYCOL'", "'IDENTITY_INSERT'", "'IF'", 
			...
			"'TEXTSIZE'", "'THEN'", "'TO'", "'TOP'", "'TRAN'", "'TRANSACTION'", "'TRUE'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FREETEXTTABLE", "FROM", "FALSE", "FULL", "FUNCTION", "GOTO", "GO", "GRANT", 
			...
			"TRUE", "TRIGGER", "TRUNCATE", "TRY_CONVERT", "TSEQUAL", "UNION", "UNIQUE", 
			"UNPIVOT", "UPDATE", "UPDATETEXT", "USE", "USER", "VALUES", "VARYING", 
			"VIEW", "WAITFOR", "WHEN", "WHERE", "WHILE", "WITH", "WITHIN", "WRITETEXT", 
			"ASSIGN_ADD", "ASSIGN_MIN", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "COMMA", 
			"SEMICOLON", "EQUALS", "GREATER_THAN", "LESS_THAN", "GREATER_EQUAL", 
			"LESS_EQUAL", "NOT_EQUAL", "LEFT_PAREN", "RIGHT_PAREN", "LEFT_BRACKET", 
			"RIGHT_BRACKET", "IDENTIFIER", "USER_VARIABLE", "SYSTEM_VARIABLE", "INTEGER", 
			"FLOAT", "SINGLE_QUOTE_STRING", "DOUBLE_QUOTE_STRING", "HEX_STRING", 
			"BIT_STRING", "SINGLE_LINE_COMMENT", "NESTED_BLOCK_COMMENT", "WS"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 211:
			SINGLE_QUOTE_STRING_action((RuleContext)_localctx, actionIndex);
			break;
		case 212:
			DOUBLE_QUOTE_STRING_action((RuleContext)_localctx, actionIndex);
			break;
		case 213:
			HEX_STRING_action((RuleContext)_localctx, actionIndex);
			break;
		case 214:
			BIT_STRING_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	private void SINGLE_QUOTE_STRING_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
	...
	private void DOUBLE_QUOTE_STRING_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 1:
	...
	private void BIT_STRING_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 3:
